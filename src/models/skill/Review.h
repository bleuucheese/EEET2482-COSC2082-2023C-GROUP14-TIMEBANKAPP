...
public:
    ...
    Review(string listingID, int skillRating, int supporterRating, std::string comments, string reviewer, string reviewee);

    // Constructor for review by supporter
    Review(string listingID, int hostRating, std::string comments, string reviewer, string reviewee);
